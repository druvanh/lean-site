document.addEventListener('DOMContentLoaded', () => {
    ...
    const fatherBot = {
        ...
        "/tired": "You've been pushing hard. Rest is not giving up — it's preparation. Take the time. You'll come back sharper.",
    ...
    function handleMessage() {
        ...
        if (window.analyticsTrack) window.analyticsTrack(text, currentMode);
        userInput.value = '';
